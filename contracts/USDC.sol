...
contract USDC {
    string public name = "nUSDC"; // Name of the token using fake money
    string public symbol = "nUSDC"; // Token Symbol Will be displayed as nUSDC when token is deployed
    uint256 public totalSupply = 100000000000000000000000; // Token Supply is 1 Billion
